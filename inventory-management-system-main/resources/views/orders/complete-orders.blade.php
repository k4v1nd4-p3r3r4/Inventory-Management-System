        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">{{ __('Orders: ') }}
                        <x-status dot color="green" class="text-uppercase">{{ __('Complete') }}</x-status>
                    </h3>
                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('orders.show', $order->id) }}" class="btn btn-icon btn-outline-success">
                                        ...
                                        <a href="{{ route('order.downloadInvoice', $order->id) }}" class="btn btn-icon btn-outline-warning">
                ...
                <div class="card-footer">
                    {{-- Add pagination or other footer actions here --}}
                </div>
            </div>
        </div>
    @endif
