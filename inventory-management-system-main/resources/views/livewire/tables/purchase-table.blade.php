            ...
            @forelse ($purchases as $purchase)
                <tr>
                    ...
                    @if ($purchase->status === \App\Enums\PurchaseStatus::APPROVED)
                        ...
                        <td class="align-middle text-center">
                            <x-button.show class="btn-icon" route="{{ route('purchases.edit', $purchase) }}"/>
                        </td>
                    @else
                        <td class="align-middle text-center">
                        ...
                        <td class="align-middle text-center" style="width: 10%">
                            ...
                            <x-button.complete class="btn-icon" route="{{ route('purchases.update', $purchase) }}" onclick="return confirm('Are you sure to approve purchase no. {{ $purchase->purchase_no }}?')"/>
                            <x-button.delete class="btn-icon" onclick="return confirm('Are you sure!')" route="{{ route('purchases.delete', $purchase) }}"/>
                        </td>
                    @endif
                </tr>
                @empty
