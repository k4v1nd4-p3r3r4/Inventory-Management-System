                                ...
                                <div class="row row-cards">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <select class="form-select form-control-solid @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                            ...
                                            <option value="BRI" @if(old('bank_name') == 'RDB ')selected="selected"@endif>RDB</option>
                                            <option value="BNI" @if(old('bank_name') == 'BOC')selected="selected"@endif>BOC</option>
                                            <option value="BCA" @if(old('bank_name') == 'DFCC')selected="selected"@endif>DFCC</option>
                                            <option value="BSI" @if(old('bank_name') == 'HNB')selected="selected"@endif>HNB</option>
                                            <option value="Mandiri" @if(old('bank_name') == 'RDB')selected="selected"@endif>RDB</option>
                                        </select>
