...
"));
    ...
    public function show(Purchase $purchase)
    {
        ...
        $products = collect(DB::select("SELECT * FROM purchase_details WHERE purchase_id = ?", [$purchase->id]));
    ...
    public function edit(Purchase $purchase)
    {
        ...
        $purchaseWithRelations = collect(DB::select("
        SELECT purchases.*, suppliers.*, purchase_details.*
        FROM purchases
        JOIN suppliers ON purchases.supplier_id = suppliers.id
